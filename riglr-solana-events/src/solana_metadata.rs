...
mod tests {
    ...
    fn test_event_kind_when_liquidate_should_return_custom_liquidation() {
        ...
        assert_eq!(
            metadata.event_kind(),
            EventKind::Custom("liquidation".to_string())
        );
    }

    #[test]
    fn test_event_kind_when_deposit_should_return_custom_deposit() {
        let core = create_test_core_metadata();
        let metadata = SolanaEventMetadata::new(
            "sig".to_string(),
            100,
        ...
        assert_eq!(
            metadata.event_kind(),
            EventKind::Custom("deposit".to_string())
        );
    }

    #[test]
    fn test_event_kind_when_withdraw_should_return_custom_withdraw() {
        let core = create_test_core_metadata();
        let metadata = SolanaEventMetadata::new(
            "sig".to_string(),
            100,
        ...
        assert_eq!(
            metadata.event_kind(),
            EventKind::Custom("withdraw".to_string())
        );
    }
    ...
    fn test_event_kind_when_create_pool_should_return_custom_create_pool() {
        ...
        assert_eq!(
            metadata.event_kind(),
            EventKind::Custom("create_pool".to_string())
        );
    }

    #[test]
    fn test_event_kind_when_add_liquidity_should_return_custom_add_liquidity() {
        let core = create_test_core_metadata();
        let metadata = SolanaEventMetadata::new(
            "sig".to_string(),
            100,
        ...
        assert_eq!(
            metadata.event_kind(),
            EventKind::Custom("add_liquidity".to_string())
        );
    }

    #[test]
    fn test_event_kind_when_remove_liquidity_should_return_custom_remove_liquidity() {
        let core = create_test_core_metadata();
        let metadata = SolanaEventMetadata::new(
            "sig".to_string(),
            100,
        ...
        assert_eq!(
            metadata.event_kind(),
            EventKind::Custom("remove_liquidity".to_string())
        );
    }
    ...
    #[test]
    fn test_event_kind_when_other_variant_should_return_custom_unknown() {
        let core = create_test_core_metadata();
        let metadata = SolanaEventMetadata::new(
            "sig".to_string(),
            100,
            EventType::Block, // Any variant not explicitly handled
            ProtocolType::default(),
            "0".to_string(),
            1000,
            core,
