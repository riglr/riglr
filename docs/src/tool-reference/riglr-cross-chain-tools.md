# riglr-cross-chain-tools Tool Reference

This page contains documentation for tools provided by the `riglr-cross-chain-tools` crate.

## Available Tools

- [`get_cross_chain_routes`](#get_cross_chain_routes) - src/bridge.rs
- [`execute_cross_chain_bridge`](#execute_cross_chain_bridge) - src/bridge.rs
- [`get_bridge_status`](#get_bridge_status) - src/bridge.rs
- [`estimate_bridge_fees`](#estimate_bridge_fees) - src/bridge.rs
- [`get_supported_chains`](#get_supported_chains) - src/bridge.rs
