...
pub trait SolanaAppContextProvider {
    ...
    /// # Errors
    ///
    /// Returns a `ToolError` if the Solana client is not configured in the `ApplicationContext`.
...
pub trait EvmAppContextProvider {
    ...
    /// # Errors
    ///
    /// Returns a `ToolError` if the EVM client is not configured in the `ApplicationContext`.
...
pub trait AppContextExtension<T> {
    ...
    /// # Errors
    ///
    /// Returns a `ToolError` if the client of type T is not configured in the `ApplicationContext`.
