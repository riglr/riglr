...
// Re-export error types for library API usability
pub use error::Error as CrossChainError;

// Re-export main bridge tools for library API usability
pub use bridge::*;
pub use lifi::*;

// Re-export common error types for library API usability
    ...
    fn test_version_when_accessed_should_return_valid_semver_string() {
        ...
        for (i, part) in parts.iter().take(3).enumerate() {
            ...
            assert!(
                ...
                "Version part {i} should be numeric, got: {numeric_part}"
            );
        }
    }
