...
impl PartialEq for AuthError {
    ...
    fn eq(&self, other: &Self) -> bool {
        match (self, other) {
            (&Self::ApiError(ref a), &Self::ApiError(ref b))
            | (&Self::ConfigError(ref a), &Self::ConfigError(ref b))
            | (&Self::MissingCredential(ref a), &Self::MissingCredential(ref b))
            | (&Self::NoWallet(ref a), &Self::NoWallet(ref b))
            | (&Self::NotVerified(ref a), &Self::NotVerified(ref b))
            | (&Self::TokenValidation(ref a), &Self::TokenValidation(ref b))
            | (&Self::UnsupportedOperation(ref a), &Self::UnsupportedOperation(ref b)) => a == b,
...
mod tests {
    ...
    fn test_token_validation_error_with_empty_message() {
        let error = AuthError::TokenValidation(String::new());
    ...
    fn test_missing_credential_error_with_empty_message() {
        let error = AuthError::MissingCredential(String::new());
    ...
    fn test_not_verified_error_with_empty_message() {
        let error = AuthError::NotVerified(String::new());
    ...
    fn test_api_error_with_empty_message() {
        let error = AuthError::ApiError(String::new());
    ...
    fn test_config_error_with_empty_message() {
        let error = AuthError::ConfigError(String::new());
    ...
    fn test_unsupported_operation_error_with_empty_message() {
        let error = AuthError::UnsupportedOperation(String::new());
    ...
    fn test_no_wallet_error_with_empty_message() {
        let error = AuthError::NoWallet(String::new());
    ...
    fn test_auth_result_type_alias_err() {
        ...
        assert_eq!(
            result,
            Err(AuthError::TokenValidation("bad token".to_string()))
        );
    }
