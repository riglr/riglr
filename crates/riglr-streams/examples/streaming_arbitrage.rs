...
use riglr_streams::evm::{ChainId, StreamConfig, WebSocketStream};
...
async fn main() -> Result<(), Box<dyn CoreError>> {
    ...
    */
    ...
    let mut evm_stream = WebSocketStream::new("ethereum-mainnet".to_string());
    let evm_config = StreamConfig {
