...
mod tests {
    ...
    fn test_condition_module_exports_are_accessible() {
        ...
        let _ = PhantomData::<Box<dyn EventCondition>>;
        let _ = PhantomData::<condition::Matcher>;
        let _ = PhantomData::<ConditionCombinator>;
    }
    ...
    fn test_event_triggered_module_exports_are_accessible() {
        ...
        use core::marker::PhantomData;
        let _ = PhantomData::<Box<dyn StreamingTool>>;
    }
    ...
    fn test_worker_extension_module_exports_are_accessible() {
        ...
        use core::marker::PhantomData;
        let _ = PhantomData::<StreamingToolWorker>;
    }
    ...
    fn test_re_exports_follow_naming_convention() {
        ...
        let _condition_exports = [
            type_name::<Box<dyn EventCondition>>(),
            type_name::<condition::Matcher>(),
            type_name::<ConditionCombinator>(),
        ];

        // All event-triggered exports should be from event_triggered module
        let _event_triggered_exports = [type_name::<Box<dyn StreamingTool>>()];

        // Worker extension export
        let _worker_export = type_name::<StreamingToolWorker>();
