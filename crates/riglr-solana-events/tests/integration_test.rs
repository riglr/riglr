...
use riglr_solana_events::metadata_helpers::create_core_metadata;
use riglr_solana_events::solana_metadata::SolanaEventMetadata;
use riglr_solana_events::types::metadata_helpers::create_solana_metadata;
...
fn test_bonk_parser_metadata_creation() {
    ...
    let program_id =
        Pubkey::from_str("11111111111111111111111111111112").expect("Should parse valid pubkey");
...
fn test_enrichment_pipeline_metadata_creation() {
    ...
    // Jupiter test
    let jupiter_metadata = create_solana_metadata(
        "test-id".to_string(),
        "test_sig".to_string(),
        100,
        1_640_995_200,
    ...
    // Raydium AMM V4 test
    let raydium_metadata = create_solana_metadata(
        "test-id".to_string(),
        "test_sig".to_string(),
        100,
        1_640_995_200,
    ...
    // Orca Whirlpool test
    let orca_metadata = create_solana_metadata(
        "test-id".to_string(),
        "test_sig".to_string(),
        100,
        1_640_995_200,
