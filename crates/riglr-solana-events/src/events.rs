...
macro_rules! match_event {
    ($event:expr_2021, { $($event_type:ty => |$var:ident: $event_type_full:ty| $body:block),* $(,)? }) => {
        {
...
mod tests {
    use super::{EventParserRegistry, EventType, Protocol, ProtocolType};
    use core::any::Any;
    ...
    #[test]
    fn match_event_macro_when_swap_event_should_execute_swap_branch() {
    ...
    #[test]
    fn match_event_macro_when_transfer_event_should_execute_transfer_branch() {
        let transfer_event = MockTransferEvent {
            destination: "test_address".to_owned(),
        };
    ...
    #[test]
    fn match_event_macro_when_no_match_should_not_execute_any_branch() {
    ...
    #[test]
    fn match_event_macro_when_multiple_types_should_match_first_applicable() {
    ...
    #[test]
    fn match_event_macro_when_empty_event_list_should_not_panic() {
    ...
    #[test]
    fn match_event_macro_when_same_type_multiple_times_should_match_first() {
    ...
    #[test]
    fn match_event_macro_with_trailing_comma_should_work() {
        let transfer_event = MockTransferEvent {
            destination: "trailing_comma_test".to_owned(),
        };
    ...
    fn re_exports_are_accessible() {
        ...
        let registry: EventParserRegistry = EventParserRegistry::new();
        let protocol: Protocol = Protocol::Jupiter;
        let event_type: EventType = EventType::Swap;
        let protocol_type: ProtocolType = ProtocolType::Jupiter;

        // Use the values to ensure they have effects
        black_box((registry, protocol, event_type, protocol_type));
    }
}
