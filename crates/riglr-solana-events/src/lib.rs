...
pub mod prelude {
    ...
    pub use crate::parsers::{
        metaplex::Parser as MetaplexParser, metaplex::ParserFactory as MetaplexParserFactory,
        pump_fun::ParserFactory as PumpFunParserFactory, raydium_v4::Parser as RaydiumV4Parser,
        raydium_v4::ParserFactory as RaydiumV4ParserFactory, JupiterParser, JupiterParserFactory,
        PumpFunParser,
    };
...
// Re-export key types at crate root for library API convenience
...
pub use error::{Error as ParseError, EventErr as EventError, EventResult, ParseResult};
...
mod tests {
    ...
    fn prelude_imports() {
        ...
        let _: EventType = EventType::Swap;
        let _: ProtocolType = ProtocolType::Jupiter;
    }

    #[test]
    fn core_module_backward_compatibility() {
    ...
    #[test]
    fn crate_root_exports() {
        // Test that main exports at crate root are accessible
        let _: crate::EventType = crate::EventType::Swap;
        let _: crate::ProtocolType = crate::ProtocolType::Jupiter;
    }
}
