...
mod tests {
    ...
    async fn test_composite_factory_with_auth_providers() {
        ...
        let privy_config = PrivyConfig::new(
            "test_app_id".to_string(),
            "test_app_secret".to_string(),
        );
        ...
        let web3auth_config = Web3AuthConfig::new(
            "test_client_id".to_string(),
            "test_verifier".to_string(),
        );
    ...
    fn test_config_validation() {
        ...
        // Valid Privy config
        let valid_privy = PrivyConfig::new(
            "app_id".to_string(),
        ...
        let invalid_privy = PrivyConfig::new(
            "".to_string(),
            "app_secret".to_string(),
        );
        ...
        let valid_web3auth = Web3AuthConfig::new(
            "client_id".to_string(),
            "verifier".to_string(),
        );
        ...
        let invalid_web3auth = Web3AuthConfig::new(
            "client_id".to_string(),
            "".to_string(),
        );
        ...
        // Valid Magic config
        let valid_magic = MagicConfig::new(
        ...
        let invalid_magic = MagicConfig::new(
            "publishable_key".to_string(),
            "".to_string(),
        );
