...
impl DatabaseConfig {
    ...
    fn validate_neo4j_url(&self, url: &str) -> ConfigResult<()> {
        ...
        Url::parse(url)
            .map_err(|e| ConfigError::validation(format!("Invalid Neo4j URL: {}", e)))?;
    ...
    fn validate_clickhouse_url(&self, url: &str) -> ConfigResult<()> {
        ...
        Url::parse(url)
            .map_err(|e| ConfigError::validation(format!("Invalid ClickHouse URL: {}", e)))?;
    ...
    fn validate_postgres_url(&self, url: &str) -> ConfigResult<()> {
        ...
        Url::parse(url)
            .map_err(|e| ConfigError::validation(format!("Invalid PostgreSQL URL: {}", e)))?;
